    ...
    <div className='grid grid-cols-4 py-8 rounded-lg shadow-custom bg-white'>
      <div className='flex items-center justify-center'>
        <div className='flex justify-start flex-col gap-2'>
          ...
          <div className='font-semibold text-base text-[#5D6679]'>{total}</div>
        </div>
      </div>
      ...
      <div className='flex items-center justify-center'>
        <div className='flex justify-start flex-col gap-2'>
          ...
          <div className='font-semibold text-base text-[#5D6679]'>{happened}</div>
        </div>
      </div>
      ...
      <div className='flex items-center justify-center'>
        <div className='flex justify-start flex-col gap-2'>
          ...
          <div className='font-semibold text-base text-[#5D6679]'>{notHappened}</div>
        </div>
      </div>
      ...
      <div className='flex items-center justify-center'>
        <div className='flex justify-start flex-col gap-2'>
          ...
          <div className='font-semibold text-base text-[#5D6679]'>{notParticipated}</div>
        </div>
      </div>
    </div>
  );
